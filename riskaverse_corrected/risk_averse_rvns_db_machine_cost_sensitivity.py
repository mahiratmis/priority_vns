        ...
        if case['simulationGAresults']['skill_cost_factor']==0.1:
            if case['simulationGAresults']['utilization_rate'] ==0.8:
                for mc_multiplier in [1.4, 1.8]:       
                    ...
                    machineCost=mc_multiplier*case['simulationGAresults']['machine_cost']
                    ...
                    VNS_SimOpt["param_value"]= mc_multiplier
