...
for lamda in [0, 0.5, 1]:
    ...
    for i in range(len(df)):
        ...
        for fr_multiplier in [0.9, 0.8, 0.6, 0.4, 0.2]:  # failure rate sensivity
            ...
            FailureRates = fr_multiplier * np.array(ast.literal_eval(df["FailureRates"][i]))
            ...
            Parameter_Value.append(fr_multiplier)
