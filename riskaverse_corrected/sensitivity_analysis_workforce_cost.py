...
for lamda in [0, 0.5, 1]:
    ...
    for i in range(len(df)):
        ...
        for wf_multiplier in [0.2, 0.6, 1.0, 1.4, 1.8]:  # workforce cost sensivity
            ...
            machine_cost = wf_multiplier * df["machineCost"][i]
            ...
            Parameter_Value.append(wf_multiplier)
